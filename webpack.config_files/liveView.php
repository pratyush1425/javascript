...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=109366&cbuster=%%CACHEBUSTER%%&cbuster=1652554849',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"101.0.4951.67","browserVersionMajor":"101","browserVersionMinor":"0","chromeVersion":"101"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'IN',
					dmaCode: 0,
					dynamicSetup: [],
